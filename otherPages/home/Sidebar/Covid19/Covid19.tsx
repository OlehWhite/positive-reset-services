      ...
      <Wrapper>
        <Box>
          ...
          <Text>
            ...
            viruses. <br />
            - Ongoing Training: In addition to our regular training, we are completing enhanced
            COVID-19 awareness training as a team. <br />- Potential Exposure: Employees who exhibit
            COVID-19 symptoms, those who live with someone exhibiting symptoms, or anyone who has
            been exposed to the virus are mandated to not come to work.
          </Text>
          <Text>
          ...
          <Box sx={{ display: "flex" }}>
            <Link href={project?.links[0].link} target="_blank">
              <Image src={IMGFacebook} alt="Facebook" title="Facebook" width={22} height={22} />
            </Link>

            <Link href={project?.links[3].link} target="_blank">
              <Image src={IMGInstagram} alt="Linkedin" title="Linkedin" width={22} height={22} />
            </Link>
          </Box>
        </Box>
      </Wrapper>
